...
fun main() {
    ...
    val pedidosFretGratis: Map<Pedido, Boolean> = pedidos.associateWith { pedido ->
        pedido.valor > 50.0
    }
    println(pedidosFretGratis)
    println(pedidosFretGratis[Pedido(2, 60.0)])

//    val mapa : Map<Boolean, Pedido> = pedidos. associateBy { pedido ->
//        pedido.valor > 50.0
//    }
//    println(mapa) uma possibilidade falha .
